...
export function NavbarDefault() {
  ...
  return (
    <Navbar className=" fixed top-0   px-4 py-2 lg:px-8 lg:py-4 max-w-none z-50 rounded-none  shadow-xl bg-purple-50 text-white overflow-visible border-none">
      <div className="container mx-auto flex items-center justify-between text-purple-500">
        <Typography
          ...
          // style={{textShadow:"1rem .1rem .1rem rgba(12, 12, 12, 0.5),-.15rem .15rem .3rem rgba(12, 12, 12, 0.5)"}}
        style={{textShadow:" .05rem .04rem .06rem purple, -.05rem -.06rem .05rem rgba(9, 8, 8, 0.91)", }}
        >
          V-Serve
        </Typography>
        ...
        <div className="flex items-center gap-x-1">
          <Link to="/login">
          <Button variant="text" size="sm" className="hidden lg:inline-block bg-gradient-to-tl from-purple-800 via-purple-600 to-purple-300 text-white capitalize hover:bg-purple-300 shadow-xl">
            <span>Log In</span>
          </Button>
          </Link>
      ...
      <Collapse open={openNav}>
        <div className="container mx-auto">
          ...
          <div className="flex items-center gap-x-1">
            <Link to="/login">
            <Button fullWidth variant="text"  className="bg-gradient-to-tl from-purple-800 via-purple-600 to-purple-300 text-white capitalize text-sm">
              <span>Log In</span>
            </Button>
            </Link>
