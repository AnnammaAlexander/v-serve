...
import { sendMessage } from "../../../API/user/apiChatConnection";
function Chat() {
...
console.log(";;;;;;;;;;;;;",currentMessages);
  return (
    <div className="fixed right-3 bottom-3 z-50">
      <Button
        className="rounded-full h-16 w-16 bg-gradient-to-t from-purple-700 via-purple-500 to-purple-400 justify-center items-center shadow-2xl focus:outline-none active:outline-none transform-none"
        onClick={openDrawer}
        size="sm"
      >
        {open ? (
          <XMarkIcon className="h-8 w-8 text-white block m-auto" />
        ) : (
          <EnvelopeIcon className="h-8 w-8 text-white block m-auto text-2xl shadow-2xl" />
        )}
      </Button>
      {open && (
        <div className="absolute h-[32rem] bottom-20 w-72 right-1 rounded-xl bg-blue-100 overflow-hidden shadow-2xl">
          <div className="h-1/4 bg-gradient-to-t from-purple-900 via-purple-500 to-purple-400">
            ...
            <div className="flex">
              ...
              <div className="">
                ...
                <p className="bg-gradient-to-t from-purple-500 via-purple-400 to-purple-400 text-white rounded-xl p-2">
                  Welcome to <b>V-Serve!</b> Is there anything we can help you with?
                </p>
              </div>
            </div>
